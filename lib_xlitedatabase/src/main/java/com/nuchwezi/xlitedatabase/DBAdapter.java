...
public class DBAdapter {
	...
	public void cacheSET(String KEY, String value) {
		DictionaryKeyValue keyValueMap = new DictionaryKeyValue(KEY, value);
		if(existsDictionaryKey(KEY)){
			updateDictionaryEntry(keyValueMap);
		}else
			createDictionaryEntry(keyValueMap);
	}

	public String cacheGET(String KEY) {
		if(existsDictionaryKey(KEY)){
			return fetchDictionaryEntry(KEY);
		}
	...
	public static final class KEYS {
		public static final String CACHE_DATASET = "CACHE_DATASET";
	}
